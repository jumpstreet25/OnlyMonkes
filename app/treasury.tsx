 ...
 * only ever reads public on-chain state. Same worker backs both the 3.4
 * line and this 3.3 port — no backend change needed here.
 *
 * 3.3 port of the master-branch screen (2026-08-28) — this line has no
 * WorldScreenShell, so it follows portfolio.tsx's plain header pattern
 * instead of the Worlds-aware shell master uses.
 *
...
import { View, Text, StyleSheet, ScrollView, StatusBar, ActivityIndicator, RefreshControl, Pressable, Linking } from "react-native";
...
const styles = StyleSheet.create({
  ...
  row: {
    ...
    backgroundColor: "rgba(255,255,255,0.03)", borderWidth: 0.75, borderColor: "rgba(255,255,255,0.06)",
  },
