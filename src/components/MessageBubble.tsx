        ...
        >
          {!isMedia ? (
            ...
            <View style={[
              ...
              {shopStyles.glowColor ? (
                <View pointerEvents="none" style={{ position: "absolute", top: -8, left: -8, right: -8, bottom: 2, borderRadius: 32, overflow: "hidden" }}>
                  <View style={{ flex: 1, backgroundColor: (shopStyles.glowColor as string) + "70", borderRadius: 32 }} />
                  <BlurView intensity={80} tint="dark" style={StyleSheet.absoluteFill} />
                </View>
              ) : null}
              {isOwn && shopStyles.pfpThemeEnabled && nftDominantColor && !shopStyles.glowColor ? (
                <View pointerEvents="none" style={{ position: "absolute", top: -6, left: -6, right: -6, bottom: 2, borderRadius: 30, overflow: "hidden" }}>
