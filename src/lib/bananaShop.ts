...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  },
  {
    ...
    preview: "✨",
    style: { glowColor: "#FFD700", glowOpacity: 0.7, glowRadius: 18 },
  },
  {
    id: "bubble_frosted",
    name: "Frosted Ice",
  ...
  },
  {
    ...
    category: "text", tier: 2, bananaCost: 30, usdCost: 2,
    preview: "🅱️",
  ...
  },
  {
    id: "text_mono",
    name: "Monospace Mode",
    description: "Messages in JetBrains Mono — coder aesthetic",
    category: "text", tier: 2, bananaCost: 30, usdCost: 2,
    preview: "⌨️",
  ...
  },
  {
    ...
    category: "pfp", tier: 3, bananaCost: 75, usdCost: 3,
    preview: "💫",
