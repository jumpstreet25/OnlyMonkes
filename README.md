...
- **LLM chain** — Groq `openai/gpt-oss-20b` (`GROQ_FAST_MODEL`) → Gemini 3.6 Flash → OpenRouter Llama 3.3 70B → CPU Ollama last-resort on the VPS. Cerebras opt-in. See `Monke_Eliza/agents/monke-trader/VPS.md`.
